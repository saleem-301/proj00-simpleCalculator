...
if(calc.operator === "Add"){
    ...
    console.log(`Subtracting ${calc.secondNumber} from ${calc.firstNumber} =`,
    calc.firstNumber - calc.secondNumber)
}
else if(calc.operator === "Mult"){
    console.log("The Product is = ", calc.firstNumber * calc.secondNumber)
}
else{console.log("The Result is = ",calc.firstNumber / calc.secondNumber)}
